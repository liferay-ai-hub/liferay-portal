...
public class MetricsActivityNodeSelectionFDSFilter
		...
		try {
			...
			dynamicQuery.setProjection(
				ProjectionFactoryUtil.distinct(
					ProjectionFactoryUtil.property("kaleoNodeName")));

			List<String> nodeNames = _kaleoLogLocalService.dynamicQuery(
				dynamicQuery);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MetricsActivityNodeSelectionFDSFilter.class);
