...
public class ProvisioningRequestResourceTest
	...
	public void testPostProvisioning() throws Exception {
		String finalCustomerName = StringUtil.randomId();
		...
		AccountEntry accountEntry =
			_accountEntryLocalService.getAccountEntryByExternalReferenceCode(
				finalCustomerName, TestPropsValues.getCompanyId());

		Assert.assertEquals(finalCustomerName, accountEntry.getName());

		User user = _userLocalService.getUserByScreenName(
			TestPropsValues.getCompanyId(),
			finalCustomerName + "-service-account");
