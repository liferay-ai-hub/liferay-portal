...
public abstract class BaseMessageResourceImpl implements MessageResource {
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ai-hub/v1.0/chats/by-external-reference-code/{externalReferenceCode}/messages' -d $'{"chatbotExternalReferenceCode": ___, "context": ___, "text": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
